...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "relative flex h-9 min-w-0 items-center rounded-[3px] border border-input bg-control shadow-[inset_0_1px_0_rgb(0_0_0/0.035)] transition-[border-color,box-shadow,background-color] duration-150",
