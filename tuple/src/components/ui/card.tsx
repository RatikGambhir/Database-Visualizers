...
function Card({ className, asChild = false, ...props }: React.ComponentProps<"div"> & { asChild?: boolean }) {
  ...
  return <Comp data-slot="card" className={cn("rounded-xl border border-border/80 bg-card text-card-foreground shadow-[0_1px_2px_rgb(0_0_0/0.04)]", className)} {...props} />
}
